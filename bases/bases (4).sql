...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-11-2024 a las 01:16:33
...
--
ALTER TABLE `cita`
  MODIFY `id_Cita` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Llave primaria autoincrementable de la cita', AUTO_INCREMENT=29;
